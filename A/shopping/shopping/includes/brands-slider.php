<div id="brands-carousel" class="logo-slider wow fadeInUp">
		...
		<div class="logo-slider-inner">	
			<div id="brand-slider" class="owl-carousel brand-slider custom-carousel owl-theme">
				...
				<div class="item">
					<a href="#" class="image">
						<img data-echo="brandsimage/dell.jpg" src="#" alt="">
					</a>	
				</div>
<div class="item">
					<a href="#" class="image">
						<img data-echo="brandsimage/samsung.jpg" src="#" alt="">
					</a>	
				</div>
				<div class="item">
					<a href="#" class="image">
						<img data-echo="brandsimage/hcl.jpg" src="#f" alt="">
					</a>	
				</div>
