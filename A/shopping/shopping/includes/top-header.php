...
<li><a href="./admin/"><i class="icon fa fa-sign-in"></i>&nbsp Seller</a></li> 
	<li><a href="my-account.php"><i class="icon fa fa-user"></i>Feedback</a></li>
					
					<?php if(strlen($_SESSION['login'])==0)
    {   ?>
<li><a href="login.php"><i class="icon fa fa-sign-in"></i> Users Login</a></li>
<?php }
else{ ?>
